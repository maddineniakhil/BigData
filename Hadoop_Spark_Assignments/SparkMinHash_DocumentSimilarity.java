...
/**
* following is the Code to calculate cartesian product and filter out repeated pairs.
*/
//public JavaRDD<T> filter(Function<Tuple2<Tuple2<String, List<String>>, Tuple2<String, List<String>>>, Boolean> f);
JavaPairRDD<Tuple2<String, String[]>, Tuple2<String, String[]>> cart = shinglesDocs.cartesian(shinglesDocs).filter(new Function<Tuple2<Tuple2<String, String[]>, Tuple2<String, String[]>>, Boolean>() {
/**
*
*/
...
return (Integer.parseInt((bucketDocument._1.toString().substring(19,20)))<Integer.parseInt((bucketDocument._2.toString().substring(19,20))));
}
});
System.out.printf("Cartesian Products : ");
System.out.println(cart.take((int) cart.count()).toString());
/**
* following is the Code to iterate through the cartesian product elements and invoke jaccard similarity for each of the cartesian results.
*/
Iterator<Tuple2<Tuple2<String, String[]>, Tuple2<String, String[]>>> iterator = cart.collect().iterator();
while (iterator.hasNext()) {
Tuple2<Tuple2<String, String[]>, Tuple2<String, String[]>> temp = iterator.next();
if (!temp._1._1.equals(temp._2._1)) {
String key = temp._1._1.substring(15, 18) + "-" + temp._2._1.substring(15, 18);
int index1 = 0;
...
System.out.println("Similarity for : " + key + " is : " + similarity);
}
}
vocabSize.unpersist();
vocabSize.destroy();
